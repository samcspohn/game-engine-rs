...
pub struct ParticleTextures {
    pub color_tex: (Arc<ImageView<ImmutableImage>>, Arc<Sampler>),
    tex_man: Arc<Mutex<TextureManager>>,
    textures: HashMap<i32, u32>,
    pub samplers: Vec<(Arc<ImageView<ImmutableImage>>, Arc<Sampler>)>,
    id: u32,
}
impl ParticleTextures {
    ...
    pub fn new(
        tex_man: Arc<Mutex<TextureManager>>,
        color_tex: (Arc<ImageView<ImmutableImage>>, Arc<Sampler>),
    ) -> Self {
        Self {
            color_tex,
            tex_man,
